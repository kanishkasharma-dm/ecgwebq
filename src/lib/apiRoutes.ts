...
export const ADMIN_ROUTES = {
  ...
  s3Files: normalizeRoutePath(import.meta.env.VITE_ADMIN_S3_FILES_PATH, "/api/s3-files"),
  s3FileContent: normalizeRoutePath(import.meta.env.VITE_ADMIN_S3_FILE_CONTENT_PATH, "/api/s3-file-content"),
